...
// and OrderLine are exempt because they have no organizationId of their own — each is only ever
// reached via an already-scoped parent (User/Branch, Payment/Order, Order).
const TENANT_SCOPED_MODELS = new Set([
  'Service', 'Branch', 'User', 'AuditLog',
  'Customer', 'CustomerAdjustment', 'Payment', 'Product', 'PriceGroup', 'PriceRule', 'Order',

...
const TENANT_SCOPED_MODELS = new Set([
  ...
  'Customer', 'CustomerAdjustment', 'Payment', 'Product', 'PriceGroup', 'PriceRule', 'PriceHistory', 'Notification', 'OtpCode', 'Order',
  'StockMove', 'Delivery', 'Reconciliation', 'Shift', 'CashDeposit', 'Flag', 'Vehicle', 'Supplier',
  'Counter',
  // Fuel pack
  'Tank', 'Dispenser', 'MeterReading', 'Attendant', 'AttendantAssignment',
]);
